/**
 * Mermaid C4 renderer — converts C4Model to Mermaid diagram syntax.
...
function elementToMermaid(el: C4Element): string {
...
export function renderMermaid(model: C4Model, options: MermaidOptions = {}): string {
  ...
  const diagramType = hasComponents ? "C4Component" : hasContainers ? "C4Container" : "C4Context";
  ...
  for (const el of elements) {
    lines.push(elementToMermaid(el));
  }
